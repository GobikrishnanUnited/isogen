...
//console.log('applicationDetails.organization_type.',applicationDetails.organization_type)
            ...
            <FormGroup check>
                <Label check>
                  <Input
                    ...
                    value='Yes'
                    onChange={handleInputs}
                    checked={contentDetails?.doc_set_development === 'Yes'}
                  />{' '}
                  Yes
                </Label>
              </FormGroup>
              <FormGroup check>
                <Label check>
                  <Input
                    ...
                    value='Yes'
                    onChange={handleInputs}
                    checked={contentDetails?.doc_set_development === 'No'}
                  />{' '}
                  No
                </Label>
              </FormGroup>
